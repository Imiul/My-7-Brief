...
<div class="min-h-full">
        ...
        <!-- <form action="Users.php" class="triage-form">
            <button type="submit" name="triage" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 gap-2 flex items-center">
                    Triage
            </button>
        </form> -->
        <!-- Search form ================================================= -->
        <!-- <form method="get" action="Users.php" class="flex items-center justify-center">
            <a href="Users.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        if (isset($_GET['keywords'])) {
            ...
            $fetchusers = "SELECT * FROM user WHERE username LIKE '%$keywords%'";
            $userData = $cnx->query($fetchusers);
        } 
        ?>
        <!-- Search Form End ============================================== -->
